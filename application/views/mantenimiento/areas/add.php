          ...
          <form role="form" action="<?php echo base_url();?>mantenimiento/areas/update" method="POST">
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="nombre_area" name="nombre_area" value="">
              </div>
              <div class="form-group">
                <label for="descripcion_area">Descripcion</label>
                <input type="text" class="form-control" id="descripcion_area" name="descripcion_area" value="">
              </div>
              <div class="form-group">
