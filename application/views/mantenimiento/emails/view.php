      ...
      <div class="col-md-6">
        ...
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">Categorias Emails</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            ...
            <p>
              <a class="btn btn-block btn-danger btn-sm" href="<?php echo base_url()?>mantenimiento/emails/edit/<?php echo $area->id; ?>">Editar</a>
