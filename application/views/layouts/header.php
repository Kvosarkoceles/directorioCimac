...
<head>
  ...
  <title>Directorio | CIMAC</title>
  <!-- Tell the browser to be responsive to screen width -->
  <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">

  <link rel="icon" type="image/vnd.microsoft.icon" href="<?php echo base_url();?>dist/img/favicon.ico" sizes="16x16 24x24 36x36 48x48">
  <!-- Bootstrap 3.3.7 -->
...
<!--  <script src="<?php echo base_url() ?>dist/js/validar.js"></script>-->
</head>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Directorio</b>CIMAC</span>
    </a>
